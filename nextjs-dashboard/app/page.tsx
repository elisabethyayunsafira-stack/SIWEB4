...
export default function SereneSailLogin() {
  ...
  const handleConnect = () => {
    ...
    if (!operatorId.trim() || !authKey.trim()) {
      setError("OPERATOR ID & AUTHORIZATION KEY REQUIRED");
      setStatus("INPUT ERROR — FIELDS CANNOT BE EMPTY");
    ...
    // Simulasi autentikasi 2.5 detik lalu redirect ke dashboard
    setTimeout(() => {
      setStatus("CONNECTION ESTABLISHED — REDIRECTING...");
      setStatusColor("#22c55e");
      // Redirect ke dashboard setelah 800ms
      setTimeout(() => {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Share+Tech+Mono&family=Barlow:wght@300;400;500;600&family=Orbitron:wght@400;600;700;900&display=swap');
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        html, body { width: 100%; height: 100%; background: #000; overflow: hidden; }

        .page {
          position: relative; width: 100vw; height: 100vh;
          display: flex; flex-direction: column; overflow: hidden; background: #050508;
        }
        ...
        .vignette {
          ...
          background: radial-gradient(ellipse 70% 80% at 50% 40%, transparent 30%, rgba(0,0,0,0.85) 100%);
        }
        ...
        .logo-name {
          ...
          color: #a855f7; letter-spacing: 0.1em; line-height: 1;
        }
        .logo-sub {
          font-family: 'Share Tech Mono', monospace; font-size: 7px;
          color: #9ca3af; letter-spacing: 0.22em; margin-top: 3px;
        }
        .logo-coords {
          font-family: 'Share Tech Mono', monospace; font-size: 7.5px;
          color: #6b7280; letter-spacing: 0.08em; margin-top: 6px; line-height: 1.7;
        }
        .status-pills { display: flex; gap: 20px; align-items: center; padding-top: 6px; }
        .pill {
          display: flex; align-items: center; gap: 6px;
          font-family: 'Share Tech Mono', monospace; font-size: 9px;
          color: #9ca3af; letter-spacing: 0.16em;
        }
        ...
        .modal {
          ...
          box-shadow: 0 0 60px rgba(168,85,247,0.1), 0 0 0 1px rgba(168,85,247,0.06) inset;
        ...
        .modal-title {
          ...
          text-align: center; color: #fff; letter-spacing: 0.18em; margin-bottom: 8px;
        }
        .modal-sub {
          font-family: 'Barlow', sans-serif; font-size: 13px; color: #9ca3af;
          text-align: center; margin-bottom: 30px; font-weight: 300; letter-spacing: 0.02em;
        }
        .field { margin-bottom: 18px; }
        .field-label {
          display: block; font-family: 'Share Tech Mono', monospace; font-size: 8px;
          color: #a855f7; letter-spacing: 0.28em; text-transform: uppercase; margin-bottom: 8px;
        }
        .input-wrap {
        ...
        .input-wrap:focus-within {
          border-color: rgba(168,85,247,0.55); box-shadow: 0 0 14px rgba(168,85,247,0.12);
        }
        .input-wrap svg { flex-shrink: 0; opacity: 0.45; }
        .input-wrap input {
          background: none; border: none; outline: none;
          color: #d1d5db; font-family: 'Share Tech Mono', monospace;
          font-size: 12px; width: 100%; letter-spacing: 0.06em;
        }
        ...
        .check-box {
          width: 14px; height: 14px; border: 1px solid rgba(168,85,247,0.4);
        ...
        .key-recovery {
          font-family: 'Share Tech Mono', monospace; font-size: 9px;
          color: #7c3aed; letter-spacing: 0.14em; cursor: pointer;
          text-decoration: none; transition: color 0.2s;
        }
        .key-recovery:hover { color: #c084fc; }
        .btn {
          width: 100%; height: 50px; border: none; border-radius: 4px;
          background: linear-gradient(90deg, #7c3aed 0%, #a855f7 50%, #c084fc 100%);
          color: #fff; font-family: 'Orbitron', sans-serif; font-size: 11px;
          font-weight: 700; letter-spacing: 0.22em; cursor: pointer;
        ...
        .footer-mid {
          position: relative; z-index: 10;
          display: flex; justify-content: center; gap: 32px; padding-bottom: 10px;
        }
        .footer-mid a {
          font-family: 'Share Tech Mono', monospace; font-size: 8.5px;
          color: #4b5563; letter-spacing: 0.2em; text-decoration: none;
        ...
        .footer-links a {
          font-family: 'Share Tech Mono', monospace; font-size: 7.5px;
          color: #4b5563; text-decoration: none; letter-spacing: 0.12em;
          text-transform: uppercase; transition: color 0.2s;
        }
        .footer-links a:hover { color: #9ca3af; }
        .footer-enc {
          font-family: 'Share Tech Mono', monospace; font-size: 7px;
          color: #374151; text-align: right; letter-spacing: 0.1em; line-height: 1.7;
        }
      ...
      <div className="page">
          ...
          <svg viewBox="0 0 1440 900" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
              <pattern id="dots" x="0" y="0" width="14" height="14" patternUnits="userSpaceOnUse">
                <circle cx="7" cy="7" r="1.1" fill="rgba(255,160,40,0.28)" />
              </pattern>
              <mask id="landmask">
                ...
                <ellipse cx="650" cy="160" rx="30" ry="50" fill="white" />
                <ellipse cx="700" cy="140" rx="25" ry="40" fill="white" />
              </mask>
            </defs>
            <rect width="1440" height="900" fill="url(#dots)" mask="url(#landmask)" />
          </svg>
        </div>
        <div className="vignette" />
        <svg className="route-svg" viewBox="0 0 1440 900" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
          <path d="M 350 420 Q 500 350 650 380 Q 720 395 800 370"
            stroke="rgba(168,85,247,0.35)" strokeWidth="1" fill="none" strokeDasharray="4 6" />
        ...
        <div className="topbar">
          <div className="logo-block">
            ...
            <div className="logo-text">
              ...
              <div className="logo-coords">
                LAT: 51.5074° N<br />LONG: 0.1278° W<br />BEARING: 254.0°
              </div>
            </div>
          </div>
          ...
          <div className="modal">
            ...
            <div className="field">
              ...
              <div className="input-wrap">
                ...
                <input type="text" value={operatorId} onChange={(e) => { setOperatorId(e.target.value); setError(""); }} onKeyDown={(e) => e.key === "Enter" && handleConnect()} placeholder="Alpha-9-Delta" />
              </div>
            </div>
            <div className="field">
              ...
              <div className="input-wrap">
                ...
                <input type="password" value={authKey} onChange={(e) => { setAuthKey(e.target.value); setError(""); }} onKeyDown={(e) => e.key === "Enter" && handleConnect()} placeholder="············" />
              </div>
            </div>
            {error && (
              <div style={{ marginBottom: 10, padding: "8px 12px", background: "rgba(248,113,113,0.08)", border: "1px solid rgba(248,113,113,0.3)", borderRadius: 3 }}>
                <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: 9, color: "#f87171", letterSpacing: "0.14em" }}>⚠ {error}</span>
              </div>
            )}
            <div className="row-opt">
              <div className="check-wrap" onClick={() => setStaySync(!staySync)}>
                <div className="check-box" style={{ background: staySync ? "rgba(168,85,247,0.25)" : "transparent" }}>
                  {staySync && (
              ...
              <a href="#" className="key-recovery">KEY RECOVERY</a>
            </div>
            ...
            <div className="status-row">
              ...
              <span className="stext" style={{ color: statusColor === "#22c55e" ? "#22c55e" : statusColor === "#f59e0b" ? "#f59e0b" : statusColor === "#f87171" ? "#f87171" : "#6b7280" }}>
                {status}
              </span>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <span className="footer-copy">© 2024 SERENE SAIL MARITIME INTELLIGENCE NETWORK. ALL RIGHTS RESERVED.</span>
          <div className="footer-right">
            <div className="footer-links">
              <a href="#">SECURE ACCESS POLICY</a>

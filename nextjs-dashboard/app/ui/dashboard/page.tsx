...
const vessels = [
  {
    id: "PL-992-BUMI",
    destination: "Port of Rotterdam (NLD)",
  ...
  {
    id: "PL-441-BULAN",
    destination: "Singapore Harbor (SGP)",
    statusLabel: "IN PORT",
    statusColor: "#6b7280",
    eta: "DOCKED",
    etaColor: "#e5e7eb",
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .brand {
          ...
          color: #a855f7; letter-spacing: 0.15em; white-space: nowrap; margin-right: 20px;
        }
        ...
        .icon-btn {
          ...
          cursor: pointer; color: #6b7280; transition: border-color 0.2s, color 0.2s;
        }
        ...
        .panel-header {
          display: flex; align-items: center; justify-content: space-between;
          padding: 12px 18px 10px; border-bottom: 1px solid rgba(255,255,255,0.06);
        }
        .panel-title {
          display: flex; align-items: center; gap: 9px;
          font-family: 'Share Tech Mono', monospace; font-size: 10px;
          letter-spacing: 0.2em; color: #e5e7eb; text-transform: uppercase;
        }
        ...
        .fleet-table td {
          padding: 18px 20px; border-bottom: 1px solid rgba(255,255,255,0.04);
        ...
        .map-wrap {
          position: relative; flex: 1; background: #141420; overflow: hidden;
        }
        ...
        .map-ctrl { width: 28px; height: 28px; background: rgba(10,10,20,0.88); border: 1px solid rgba(255,255,255,0.1); border-radius: 3px; display: flex; align-items: center; justify-content: center; cursor: pointer; color: #6b7280; font-family: 'Share Tech Mono', monospace; font-size: 16px; transition: border-color 0.2s, color 0.2s; user-select: none; }
        ...
        .alerts-title {
          display: flex; align-items: center; gap: 7px;
          font-family: 'Share Tech Mono', monospace; font-size: 10px; color: #e5e7eb; letter-spacing: 0.18em;
        }
      ...
      <div className="topbar">
              ...
              {showMore && (
                <div className="more-dropdown">
                  {moreMenuItems.map((item) => (
                    <button key={item} className="more-item" onClick={() => setShowMore(false)}>
                      {item}
                    </button>
                  ))}
                </div>
        ...
        <div className="topbar-right">
          ...
          <div className="icon-btn">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <circle cx="12" cy="12" r="9"/><path d="M12 3v18M3 12h9"/>
            </svg>
          </div>
          <div className="icon-btn">
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <div className="panel map-panel">
            <div className="map-outer">
              <div className="map-wrap">
                ...
                <div className="map-text" style={{ top:"22%", left:"56%" }}>Children's<br/>of th...</div>

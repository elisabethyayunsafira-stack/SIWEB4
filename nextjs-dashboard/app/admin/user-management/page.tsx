    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .reg-btn{display:flex;align-items:center;gap:8px;padding:10px 18px;background:linear-gradient(90deg,#7c3aed,#a855f7);border:none;border-radius:6px;color:#fff;font-family:'Share Tech Mono',monospace;font-size:10px;letter-spacing:0.16em;cursor:pointer;transition:opacity 0.2s}
        .reg-btn:hover{opacity:0.88}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:rgba(255,255,255,0.06);border-bottom:1px solid rgba(255,255,255,0.07)}
        .stat{background:#0f0f1a;padding:18px 24px}
        ...
        .three-dot{width:28px;height:28px;display:flex;align-items:center;justify-content:center;cursor:pointer;color:#4b5563;border-radius:3px;transition:color 0.2s,background 0.2s}
        .three-dot:hover{color:#e5e7eb;background:rgba(255,255,255,0.06)}
        .popup{position:absolute;right:40px;top:8px;background:#0f0f1a;border:1px solid rgba(255,255,255,0.12);border-radius:6px;padding:14px 16px;min-width:200px;z-index:10;box-shadow:0 8px 24px rgba(0,0,0,0.5)}
      ...
      <div className="stats-grid">
        <div className="stat"><div className="stat-lbl">ACTIVE CREW</div><div className="stat-num">142</div></div>
          ...
          {crew.map((c,i)=>(
            <tr key={i} onClick={()=>setPopup(popup===i?null:i)}>
              ...
              <td style={{position:"relative"}}>
                <div className="three-dot" onClick={e=>{e.stopPropagation();setPopup(popup===i?null:i)}}>
      ...
      <div className="showing">DISPLAYING 5 OF 142 PERSONNEL</div>

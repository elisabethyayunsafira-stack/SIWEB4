...
const packages = [
  ...
  {id:"PKG-100881",size:"MEDIUM",dest:"USA (JFK)"},
  {id:"PKG-100994",size:"MEDIUM",dest:"UK (LHR)"},
  {id:"PKG-101221",size:"MEDIUM",dest:"Brazil (GRU)"},
  {id:"PKG-101552",size:"MEDIUM",dest:"Norway (& SL)"},
];
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .stab.active{background:#a855f7;color:#fff}
        ...
        .view-all{text-align:center;padding:12px;font-family:'Share Tech Mono',monospace;font-size:9px;color:#22d3ee;cursor:pointer;border-top:1px solid rgba(255,255,255,0.05);letter-spacing:0.14em;transition:color 0.2s}
